                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    {{-- <div class="form-group col-4 clearfix">
                                        <div class="icheck-dark d-inline">
                                            <input name="is_editable" type="checkbox" id="checkboxPrimary3" {{ old('is_editable') == 'on' ? 'checked' : '' }}>
                                            <label for="checkboxPrimary3">@lang('dashboard.Editable')</label>
                                        </div>
                                    </div> --}}
                                    <div class="form-group col-4 clearfix">
                                        <div class="icheck-dark d-inline">
                                            <input name="is_deletable" type="checkbox" id="checkboxPrimary2" {{ old('is_deletable') == 'on' ? 'checked' : '' }}>
                                            <label for="checkboxPrimary2">@lang('dashboard.Deletable')</label>
                                        </div>
                                    </div>
                                    {{-- <div class="form-group col-4 clearfix">
                                        <div class="icheck-dark d-inline">
                                            <input name="has_additional_data" type="checkbox" id="checkboxPrimary2" {{ old('has_additional_data') == 'on' ? 'checked' : '' }}>
                                            <label for="checkboxPrimary2">@lang('dashboard.has_additional_data')</label>
                                        </div>
                                    </div> --}}
                                </div>
                                ...
                                <div class="form-group row">
                                    @foreach($permissions as $key => $permission)
                                        <div class="col-6">
                                            <label style="font-size: 30px" for="select">{{__('dashboard.' . $key)}}</label>
                                            <br>
