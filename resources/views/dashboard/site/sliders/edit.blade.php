...
@section('title', __('titles.Edit slider'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('sliders.update', $slider) }}" method="post" autocomplete="off"
                            enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('titles.Edit') @lang('dashboard.slider_slider')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                @method('put')
                                ...
                                @if ($slider->image !== null)
                                    <div class="col-2">
                                        <img src="{{ url($slider->image) }}" style="width: 100%;">
                                    </div>
                                @endif
                                <br>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="title_ar" type="text" class="form-control"
                                                id="exampleInputName1" value="{{ $slider->title_ar }}" placeholder=""
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="title_en" type="text" class="form-control"
                                                id="exampleInputEmail1" value="{{ $slider->title_en }}" placeholder=""
                                                required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description_ar" type="text" class="form-control" id="exampleInputName1"
                                                value="{{ $slider->description_ar }}" placeholder="" required>{{ $slider->description_ar }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description_en" type="text" class="form-control" id="exampleInputEmail1"
                                                value="{{ $slider->description_en }}" placeholder="" required>{{ $slider->description_en }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input name="is_active" type="checkbox" id="checkboxPrimary4"
                                                    {{ $slider->is_active == 'on' ? 'checked' : ($slider->is_active ? 'checked' : '') }}>
