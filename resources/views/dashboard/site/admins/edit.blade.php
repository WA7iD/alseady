    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('admins.update', [$role->name, $admin->id]) }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    @if($admin->image !== null)
                                        <div class="col-2">
                                            <img src="{{ url($admin->image) }}" style="width: 100%;">
                                        </div>
                                    @endif
                                </div>
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control" id="exampleInputName1" value="{{ old('name') ?? $admin->name }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">@lang('dashboard.Email')</label>
                                            <input name="email" type="email" class="form-control" id="exampleInputEmail1" value="{{ old('email') ?? $admin->email }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">@lang('dashboard.Phone')</label>
                                            <input name="phone" type="text" class="form-control" id="exampleInputEmail1" value="{{ old('phone') ?? $admin->phone }}" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input name="is_active" type="checkbox" id="checkboxPrimary4"
                                                    {{ old('is_active') == 'on' ? 'checked' : ($admin->is_active ? 'checked' : '') }}>
