...
@section('title', __('dashboard.positions'))
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.positions')</h3>
                            @permission('positions-create')
                                <div class="card-tools">
                                    <a href="{{ route('positions.create') }}" class="btn  btn-dark">@lang('dashboard.Create')</a>
                                </div>
                            @endpermission
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            {{ $positions->appends(request()->all())->links('pagination::simple-bootstrap-5') }}
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
